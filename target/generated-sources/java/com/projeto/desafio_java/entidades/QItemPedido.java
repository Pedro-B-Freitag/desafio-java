...
public class QItemPedido extends EntityPathBase<ItemPedido> {
    ...
    private static final long serialVersionUID = -2083214911L;
    ...
    public final QProdutoServico produto;
    ...
    public QItemPedido(Class<? extends ItemPedido> type, PathMetadata metadata, PathInits inits) {
        ...
        this.produto = inits.isInitialized("produto") ? new QProdutoServico(forProperty("produto")) : null;
    }
